...
export const metadata: Metadata = {
  title: "Disclaimer — ClaudeThings",
  description:
    "ClaudeThings disclaimer: educational content, no affiliation with Anthropic, no professional or financial advice, and the limits of what our guides and tools promise.",
  ...
  return (
    <LegalLayout title="Disclaimer" updated="July 12, 2026">
      <p className="intro">
        ...
        claudethings.com promise. It&apos;s written in plain English on purpose.
      </p>

      <h2>Independent &amp; unofficial</h2>
      <p>
        ClaudeThings is an independent product. We are <strong>not affiliated with, endorsed by,
      ...
      <p>
        The ClaudeThings kits are prompts, skills, agents, and commands — how much value they
      ...
      <h2>Liability</h2>
      <p>
        To the maximum extent permitted by law, ClaudeThings and its operators are not liable for
