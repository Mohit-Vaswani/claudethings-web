  ...
  return (
    <nav id="nav">
      <div className="nav-inner">
        <a className="logo" href="https://www.agentskit.co">
          <span className="dia">◆</span> AgentsKit
        </a>
      ...
      <div className="wrap center">
        ...
        <div className="kits" style={{ textAlign: "left" }}>
          <div className="kit eng fade">
            ...
            <a
              href="https://www.agentskit.co/#pricing"
        ...
        <p className="fade" style={{ marginTop: 26 }}>
          <a href="https://www.agentskit.co/#pricing" className="accent" style={{ fontWeight: 600 }}>
        ...
        <div className="foot-top">
          ...
          <div className="foot-links">
            <div className="foot-col">
              <h5>Product</h5>
              <a href="https://www.agentskit.co/#whats-inside">What&apos;s inside</a>
              <a href="https://www.agentskit.co/#kits">Kits</a>
              <a href="https://www.agentskit.co/#pricing">Pricing</a>
              <a href="https://www.agentskit.co/#faq">FAQ</a>
            </div>
            <div className="foot-col">
              <h5>Free Tools</h5>
            ...
            <div className="foot-col">
              ...
              <a href="https://www.agentskit.co">agentskit.co</a>
            </div>
          </div>
        </div>
