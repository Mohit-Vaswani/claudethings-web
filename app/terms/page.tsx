...
export const metadata: Metadata = {
  title: "Terms of Service · ClaudeThings",
  description: "The terms that govern your purchase and use of ClaudeThings.",
};
...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" updated="July 6, 2026">
      <p className="intro">
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of ClaudeThings
      ...
      <p>
        ClaudeThings is a curated distribution of AI engineering and marketing tooling for Claude
      ...
      <h2>4. Payment</h2>
      <p>
        ClaudeThings is sold as a one-time payment via our payment processor. Prices are shown at
      ...
      <p>
        To the maximum extent permitted by law, ClaudeThings and its operators will not be liable for
