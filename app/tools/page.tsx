...
export const metadata: Metadata = {
  title: "Free Claude Code Tools — Validators, Auditors & Skills | AgentsKit",
  description:
...
const itemListLd = {
  ...
  url: URL,
  isPartOf: { "@type": "WebSite", name: "AgentsKit", url: "https://agentskit.co" },
  mainEntity: {
    "@type": "ItemList",
    itemListElement: TOOLS.filter((t) => t.status === "live").map((t, i) => ({
      "@type": "ListItem",
      position: i + 1,
      url: `https://agentskit.co${t.slug}`,
      name: t.name,
