 ...
 *
 * www is canonical; the apex agentskit.co 308s to it, as do the legacy
 * agentary.dev and claudethings.com domains. Anything needing an absolute URL
 ...
 */
export const SITE_URL = "https://www.agentskit.co";
