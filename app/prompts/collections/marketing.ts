...
4. This week's action: one diagnostic, one experiment, expected learning from each.`,
  ...
  faq: [
    ...
    },
    {
      ...
      a: "It can draft, analyze, and strategize at a level that replaces a lot of agency work. What it can't do alone is choose what's true about your product, gather proof, or press publish. Pair it with the Agentary Marketing Kit and one decisive human, and you have a function.",
    },
  ],
};
